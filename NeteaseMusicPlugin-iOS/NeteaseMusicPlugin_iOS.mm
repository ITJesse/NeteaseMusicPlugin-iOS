//
//  NeteaseMusicPlugin_iOS.mm
//  NeteaseMusicPlugin-iOS
//
//  Created by Jesse Zhu on 2017/5/9.
...
@interface NeteaseMusicPlugin_iOS : NSObject

@end

@implementation NeteaseMusicPlugin_iOS
...
CHConstructor // code block that runs immediately upon load
{
	@autoreleasepool
	{
		...
		// this would be posted using: notify_post("com.itjesse.neteasemusicplugin.NeteaseMusicPlugin-iOS.eventname");
		CFNotificationCenterRef darwin = CFNotificationCenterGetDarwinNotifyCenter();
		CFNotificationCenterAddObserver(darwin, NULL, ExternallyPostedNotification, CFSTR("com.itjesse.neteasemusicplugin.NeteaseMusicPlugin-iOS.eventname"), NULL, CFNotificationSuspensionBehaviorCoalesce);
